module RbScope
    ...
    module API
        ...
        class << self
            attr_accessor :c_signatures, :types
        ...
        # Provide a type translator between Ruby::FFI
        # and C for automatic code generation
        @types = {
              c: {
                    p_char:   "char*",
                    p_int16:  "short*",
                    p_uint16: "unsigned short*",
                    p_int32:  "ViInt32*",   #can be long for 64bits sys
                    p_uint32: "ViUInt32*",  #can be ulong for bits sys
                    p_double: "double*",
                    pointer:  "void*",
                    int16:    "short",
                    int32:    "int",
        ...
        @c_signatures =  [
              ...
              # TODO: check timeout error, if so, abort and go back to idle state
